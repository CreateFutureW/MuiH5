...
! function(t, e) {
	...
	function n(t, n) {
		...
		for(var o in n)
			if("__proto__" !== o && i(n, o)) {
				var s = n[o];
				r(s) ? ("undefined" === L(t[o]) && "function" === L(s) && (t[o] = s), t[o] = e(t[o] || {}, s)) : t[o] = s
			}
		return t
	}
	...
	var p = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
		...
		j = function() {
			...
			if(_) return "function" == typeof window.CustomEvent ? window.CustomEvent : (t.prototype = window.Event.prototype, t)
		}(),
		z = function() {
			var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1;
			return _ ? window.devicePixelRatio || t : t
		},
		I = function() {
			if(_) {
				var t = !1;
		...
		Q = function() {
			function t(e) {
				var n = e.el,
					...
					u = e.options,
					l = e.elRenderer;
				b(this, t), this.el = n, this.src = r, this.error = i, this.loading = o, this.bindType = s, this.attempt = 0, this.naturalHeight = 0, this.naturalWidth = 0, this.options = u, this.rect = null, this.$parent = a, this.elRenderer = l, this.performanceData = {
					init: Date.now(),
					loadStart: 0,
					loadEnd: 0
		...
		B = function(t) {
			return function() {
				...
				return y(e, [{
					...
					key: "addLazyBox",
					value: function(t) {
						this.ListenerQueue.push(t), _ && (this._addListenerTarget(window), this._observer && this._observer.observe(t.el), t.$el && t.$el.parentNode && this._addListenerTarget(t.$el.parentNode))
					}
				}, {
					key: "add",
					value: function(e, n, r) {
						...
						var o = this._valueFormatter(n.value),
							...
							d = o.error;
						t.nextTick(function() {
							u = a(e, i.options.scale) || u, i._observer && i._observer.observe(e);
							var o = Object.keys(n.modifiers)[0],
								s = void 0;
							o && (s = r.context.$refs[o], s = s ? s.$el || s : document.getElementById(o)), s || (s = x(e));
							var c = new Q({
								bindType: n.arg,
								$parent: s,
								el: e,
							...
							i.ListenerQueue.push(c), _ && (i._addListenerTarget(window), i._addListenerTarget(s)), i.lazyLoadHandler(), t.nextTick(function() {
					...
					value: function(e, n, r) {
						var i = this,
							...
							l = o.loading,
							d = o.error;
						s = a(e, this.options.scale) || s;
						var c = u(this.ListenerQueue, function(t) {
							return t.el === e
						});
						c ? c.update({
							src: s,
			...
			return {
				...
				methods: {
					...
					checkInView: function() {
						return this.getRect(), _ && this.rect.top < window.innerHeight * t.options.preLoad && this.rect.bottom > 0 && this.rect.left < window.innerWidth * t.options.preLoad && this.rect.right > 0
					},
					load: function() {
			...
			return y(t, [{
				...
				value: function(t) {
					var e = this,
						n = t.el,
						r = t.binding;
					this.el = n, this.options = E({}, P, r.value), this.getImgs().forEach(function(t) {
						e.lazy.add(t, E({}, e.binding, {
							value: {
	...
	return {
		install: function(t) {
			...
			t.prototype.$Lazyload = r, e.lazyComponent && t.component("lazy-component", D(r)), e.lazyImage && t.component("lazy-image", N(r)), o ? (t.directive("lazy", {
				bind: r.add.bind(r),
				...
				update: function(t, e) {
					E(this.vm.$refs, this.vm.$els), r.add(this.el, {
